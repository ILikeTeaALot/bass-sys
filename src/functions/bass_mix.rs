...
generate_bindings! {
    ...
    pub fn BASS_Mixer_ChannelSetEnvelope(handle.into(): impl Into<DWORD>, env_type.into(): impl Into<DWORD>, nodes: &mut BASS_MIXER_NODE as *mut BASS_MIXER_NODE, count.into(): impl Into<DWORD>) -> bool;
