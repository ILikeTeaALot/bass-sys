...
pub const BASS_CONFIG_CD_FREEOLD: DWORD = DWORD(66048);
pub const BASS_CONFIG_CD_RETRY: DWORD = DWORD(66049);
pub const BASS_CONFIG_CD_AUTOSPEED: DWORD = DWORD(66050);
pub const BASS_CONFIG_CD_SKIPERROR: DWORD = DWORD(66051);
pub const BASS_CONFIG_CD_READ: DWORD = DWORD(66053);
pub const BASS_CONFIG_CD_TIMEOUT: DWORD = DWORD(66054);
pub const BASS_CONFIG_CD_CDDB_SERVER: DWORD = DWORD(66052);
pub const BASS_CD_IF_AUTO: DWORD = DWORD(0);
pub const BASS_CD_IF_SPTI: DWORD = DWORD(1);
pub const BASS_CD_IF_ASPI: DWORD = DWORD(2);
pub const BASS_CD_IF_WIO: DWORD = DWORD(3);
pub const BASS_CD_IF_LINUX: DWORD = DWORD(4);
pub const BASS_CD_RWFLAG_READCDR: DWORD = DWORD(1);
pub const BASS_CD_RWFLAG_READCDRW: DWORD = DWORD(2);
pub const BASS_CD_RWFLAG_READCDRW2: DWORD = DWORD(4);
pub const BASS_CD_RWFLAG_READDVD: DWORD = DWORD(8);
pub const BASS_CD_RWFLAG_READDVDR: DWORD = DWORD(16);
pub const BASS_CD_RWFLAG_READDVDRAM: DWORD = DWORD(32);
pub const BASS_CD_RWFLAG_READANALOG: DWORD = DWORD(65536);
pub const BASS_CD_RWFLAG_READM2F1: DWORD = DWORD(1048576);
pub const BASS_CD_RWFLAG_READM2F2: DWORD = DWORD(2097152);
pub const BASS_CD_RWFLAG_READMULTI: DWORD = DWORD(4194304);
pub const BASS_CD_RWFLAG_READCDDA: DWORD = DWORD(16777216);
pub const BASS_CD_RWFLAG_READCDDASIA: DWORD = DWORD(33554432);
pub const BASS_CD_RWFLAG_READSUBCHAN: DWORD = DWORD(67108864);
pub const BASS_CD_RWFLAG_READSUBCHANDI: DWORD = DWORD(134217728);
pub const BASS_CD_RWFLAG_READC2: DWORD = DWORD(268435456);
pub const BASS_CD_RWFLAG_READISRC: DWORD = DWORD(536870912);
pub const BASS_CD_RWFLAG_READUPC: DWORD = DWORD(1073741824);
pub const BASS_CD_SUBCHANNEL: DWORD = DWORD(512);
pub const BASS_CD_SUBCHANNEL_NOHW: DWORD = DWORD(1024);
pub const BASS_CD_C2ERRORS: DWORD = DWORD(2048);
pub const BASS_SYNC_CD_ERROR: DWORD = DWORD(1000);
pub const BASS_SYNC_CD_SPEED: DWORD = DWORD(1002);
pub const BASS_CD_DOOR_CLOSE: DWORD = DWORD(0);
pub const BASS_CD_DOOR_OPEN: DWORD = DWORD(1);
pub const BASS_CD_DOOR_LOCK: DWORD = DWORD(2);
pub const BASS_CD_DOOR_UNLOCK: DWORD = DWORD(3);
pub const BASS_CDID_UPC: DWORD = DWORD(1);
pub const BASS_CDID_CDDB: DWORD = DWORD(2);
pub const BASS_CDID_CDDB2: DWORD = DWORD(3);
pub const BASS_CDID_TEXT: DWORD = DWORD(4);
pub const BASS_CDID_CDPLAYER: DWORD = DWORD(5);
pub const BASS_CDID_MUSICBRAINZ: DWORD = DWORD(6);
pub const BASS_CDID_ISRC: DWORD = DWORD(256);
pub const BASS_CDID_CDDB_QUERY: DWORD = DWORD(512);
pub const BASS_CDID_CDDB_READ: DWORD = DWORD(513);
pub const BASS_CDID_CDDB_READ_CACHE: DWORD = DWORD(767);
pub const BASS_CD_TOC_TIME: DWORD = DWORD(256);
pub const BASS_CD_TOC_INDEX: DWORD = DWORD(512);
pub const BASS_CD_TOC_CON_PRE: DWORD = DWORD(1);
pub const BASS_CD_TOC_CON_COPY: DWORD = DWORD(2);
pub const BASS_CD_TOC_CON_DATA: DWORD = DWORD(4);
pub const BASS_CD_DATA_SUBCHANNEL: DWORD = DWORD(0);
pub const BASS_CD_DATA_C2: DWORD = DWORD(1);
pub const BASS_CD_TRACK_PREGAP: DWORD = DWORD(65535);
pub const BASS_CTYPE_STREAM_CD: DWORD = DWORD(66048);
pub const BASS_POS_CD_TRACK: DWORD = DWORD(4);
#[repr(C)]
...
const _: () = {
	["Size of BASS_CD_INFO"][::std::mem::size_of::<BASS_CD_INFO>() - 56usize];
	["Alignment of BASS_CD_INFO"][::std::mem::align_of::<BASS_CD_INFO>() - 8usize];
	["Offset of field: BASS_CD_INFO::vendor"][::std::mem::offset_of!(BASS_CD_INFO, vendor) - 0usize];
	["Offset of field: BASS_CD_INFO::product"][::std::mem::offset_of!(BASS_CD_INFO, product) - 8usize];
	["Offset of field: BASS_CD_INFO::rev"][::std::mem::offset_of!(BASS_CD_INFO, rev) - 16usize];
	["Offset of field: BASS_CD_INFO::letter"][::std::mem::offset_of!(BASS_CD_INFO, letter) - 24usize];
	["Offset of field: BASS_CD_INFO::rwflags"][::std::mem::offset_of!(BASS_CD_INFO, rwflags) - 28usize];
	["Offset of field: BASS_CD_INFO::canopen"][::std::mem::offset_of!(BASS_CD_INFO, canopen) - 32usize];
	["Offset of field: BASS_CD_INFO::canlock"][::std::mem::offset_of!(BASS_CD_INFO, canlock) - 36usize];
	["Offset of field: BASS_CD_INFO::maxspeed"][::std::mem::offset_of!(BASS_CD_INFO, maxspeed) - 40usize];
	["Offset of field: BASS_CD_INFO::cache"][::std::mem::offset_of!(BASS_CD_INFO, cache) - 44usize];
	["Offset of field: BASS_CD_INFO::cdtext"][::std::mem::offset_of!(BASS_CD_INFO, cdtext) - 48usize];
};
...
const _: () = {
	["Size of BASS_CD_TOC_TRACK__bindgen_ty_1"][::std::mem::size_of::<BASS_CD_TOC_TRACK__bindgen_ty_1>() - 4usize];
	["Alignment of BASS_CD_TOC_TRACK__bindgen_ty_1"]
		[::std::mem::align_of::<BASS_CD_TOC_TRACK__bindgen_ty_1>() - 4usize];
	["Offset of field: BASS_CD_TOC_TRACK__bindgen_ty_1::lba"]
		[::std::mem::offset_of!(BASS_CD_TOC_TRACK__bindgen_ty_1, lba) - 0usize];
	["Offset of field: BASS_CD_TOC_TRACK__bindgen_ty_1::hmsf"]
		[::std::mem::offset_of!(BASS_CD_TOC_TRACK__bindgen_ty_1, hmsf) - 0usize];
};
...
const _: () = {
	["Size of BASS_CD_TOC_TRACK"][::std::mem::size_of::<BASS_CD_TOC_TRACK>() - 8usize];
	["Alignment of BASS_CD_TOC_TRACK"][::std::mem::align_of::<BASS_CD_TOC_TRACK>() - 4usize];
	["Offset of field: BASS_CD_TOC_TRACK::res1"][::std::mem::offset_of!(BASS_CD_TOC_TRACK, res1) - 0usize];
	["Offset of field: BASS_CD_TOC_TRACK::adrcon"][::std::mem::offset_of!(BASS_CD_TOC_TRACK, adrcon) - 1usize];
	["Offset of field: BASS_CD_TOC_TRACK::track"][::std::mem::offset_of!(BASS_CD_TOC_TRACK, track) - 2usize];
	["Offset of field: BASS_CD_TOC_TRACK::res2"][::std::mem::offset_of!(BASS_CD_TOC_TRACK, res2) - 3usize];
};
...
impl ::std::fmt::Debug for BASS_CD_TOC_TRACK {
	fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
		write!(f, "BASS_CD_TOC_TRACK {{ __bindgen_anon_1: {:?} }}", self.__bindgen_anon_1)
	}
}
#[repr(C)]
...
const _: () = {
	["Size of BASS_CD_TOC"][::std::mem::size_of::<BASS_CD_TOC>() - 804usize];
	["Alignment of BASS_CD_TOC"][::std::mem::align_of::<BASS_CD_TOC>() - 4usize];
	["Offset of field: BASS_CD_TOC::size"][::std::mem::offset_of!(BASS_CD_TOC, size) - 0usize];
	["Offset of field: BASS_CD_TOC::first"][::std::mem::offset_of!(BASS_CD_TOC, first) - 2usize];
	["Offset of field: BASS_CD_TOC::last"][::std::mem::offset_of!(BASS_CD_TOC, last) - 3usize];
	["Offset of field: BASS_CD_TOC::tracks"][::std::mem::offset_of!(BASS_CD_TOC, tracks) - 4usize];
};
...
pub struct BASS_CD {
	...
	pub BASS_CD_GetTOC: unsafe extern "C" fn(drive: DWORD, mode: DWORD, toc: *mut BASS_CD_TOC) -> BOOL,
	pub BASS_CD_GetID: unsafe extern "C" fn(drive: DWORD, id: DWORD) -> *const ::std::os::raw::c_char,
	...
	pub BASS_CD_SetOffset: unsafe extern "C" fn(drive: DWORD, offset: ::std::os::raw::c_int) -> BOOL,
	pub BASS_CD_Release: unsafe extern "C" fn(drive: DWORD) -> BOOL,
	pub BASS_CD_StreamCreate: unsafe extern "C" fn(drive: DWORD, track: DWORD, flags: DWORD) -> HSTREAM,
	pub BASS_CD_StreamCreateFile: unsafe extern "C" fn(file: *const ::std::os::raw::c_char, flags: DWORD) -> HSTREAM,
	...
	pub BASS_CD_Analog_PlayFile: unsafe extern "C" fn(file: *const ::std::os::raw::c_char, pos: DWORD) -> DWORD,
...
impl BASS_CD {
		...
		L: Into<::libloading::Library>,
	{
		...
		let BASS_CD_StreamCreateFile = __library.get(b"BASS_CD_StreamCreateFile\0").map(|sym| *sym)?;
		let BASS_CD_StreamCreateEx = __library.get(b"BASS_CD_StreamCreateEx\0").map(|sym| *sym)?;
		let BASS_CD_StreamCreateFileEx = __library.get(b"BASS_CD_StreamCreateFileEx\0").map(|sym| *sym)?;
		...
		let BASS_CD_Analog_PlayFile = __library.get(b"BASS_CD_Analog_PlayFile\0").map(|sym| *sym)?;
		let BASS_CD_Analog_Stop = __library.get(b"BASS_CD_Analog_Stop\0").map(|sym| *sym)?;
		let BASS_CD_Analog_IsActive = __library.get(b"BASS_CD_Analog_IsActive\0").map(|sym| *sym)?;
		let BASS_CD_Analog_GetPosition = __library.get(b"BASS_CD_Analog_GetPosition\0").map(|sym| *sym)?;
		Ok(BASS_CD {
			__library,
	...
	pub unsafe fn BASS_CD_StreamCreateFile(&self, file: *const ::std::os::raw::c_char, flags: DWORD) -> HSTREAM {
	...
	pub unsafe fn BASS_CD_Analog_PlayFile(&self, file: *const ::std::os::raw::c_char, pos: DWORD) -> DWORD {
