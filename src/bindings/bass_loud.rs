...
pub const BASS_LOUDNESS_CURRENT: u32 = 0;
pub const BASS_LOUDNESS_INTEGRATED: u32 = 1;
pub const BASS_LOUDNESS_RANGE: u32 = 2;
pub const BASS_LOUDNESS_PEAK: u32 = 4;
pub const BASS_LOUDNESS_TRUEPEAK: u32 = 8;
pub const BASS_LOUDNESS_AUTOFREE: u32 = 32768;
#[repr(transparent)]
...
pub struct BASS_Loud {
    ...
    pub BASS_Loudness_Start: unsafe extern "C" fn(
        handle: DWORD,
        flags: DWORD,
        priority: ::std::os::raw::c_int,
    ) -> HLOUDNESS,
    pub BASS_Loudness_Stop: unsafe extern "C" fn(handle: DWORD) -> BOOL,
    pub BASS_Loudness_SetChannel: unsafe extern "C" fn(
        handle: HLOUDNESS,
        channel: DWORD,
        priority: ::std::os::raw::c_int,
    ) -> BOOL,
    pub BASS_Loudness_GetChannel: unsafe extern "C" fn(handle: HLOUDNESS) -> DWORD,
    pub BASS_Loudness_GetLevel:
        unsafe extern "C" fn(handle: HLOUDNESS, mode: DWORD, level: *mut f32) -> BOOL,
    pub BASS_Loudness_GetLevelMulti: unsafe extern "C" fn(
...
impl BASS_Loud {
        ...
        L: Into<::libloading::Library>,
    {
        ...
        let BASS_Loudness_GetVersion = __library
            .get(b"BASS_Loudness_GetVersion\0")
            .map(|sym| *sym)?;
        ...
        let BASS_Loudness_SetChannel = __library
            .get(b"BASS_Loudness_SetChannel\0")
            .map(|sym| *sym)?;
        let BASS_Loudness_GetChannel = __library
            .get(b"BASS_Loudness_GetChannel\0")
            .map(|sym| *sym)?;
        let BASS_Loudness_GetLevel = __library.get(b"BASS_Loudness_GetLevel\0").map(|sym| *sym)?;
        let BASS_Loudness_GetLevelMulti = __library
            .get(b"BASS_Loudness_GetLevelMulti\0")
            .map(|sym| *sym)?;
        Ok(BASS_Loud {
            __library,
    ...
    pub unsafe fn BASS_Loudness_GetLevel(
        &self,
        handle: HLOUDNESS,
        mode: DWORD,
        level: *mut f32,
